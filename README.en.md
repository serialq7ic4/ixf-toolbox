...
> Install https://github.com/serialq7ic4/ixf-toolbox. Use the GitHub Release Go binary for the local `ixf` engine (macOS Apple Silicon: `ixf_2.13.0_darwin_arm64`, macOS Intel: `ixf_2.13.0_darwin_amd64`, Windows: `ixf_2.13.0_windows_amd64.exe`), then run `ixf setup skills --runtimes codex --json`, and verify with `ixf --version` and `ixf doctor --json`.
...
For macOS Intel, use `ixf_2.13.0_darwin_amd64` instead.

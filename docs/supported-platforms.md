...
`v3.7.2` exposes diagnostics with remediation, dry-run open planning, explicit --apply target verification, read-only conversation extraction, and approved sends with fresh-session verification:

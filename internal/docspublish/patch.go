...
func PatchInsertMarkdown(config PatchInsertConfig) (map[string]any, error) {
	...
	payload := map[string]any{
		...
		"plannedChangeEntries":     changeEntryCount(len(entries)),
		"maxChangeEntriesPerWrite": maxChangeEntriesPerWrite,
		"fitsInOneWrite":           changeEntryCount(len(entries)) <= maxChangeEntriesPerWrite,
